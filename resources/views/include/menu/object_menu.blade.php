...
<div class="ob_menu_hor">
    ...
    <div class="ob_menu_hor__ul">
        ...
        <ul class="top_menu">
            ...
            <li class="{{ active_linkMenu(asset(route('page.object.info', ['religion_slug'=> $religion->slug ,'object_slug'=> $item->slug  ] ) )) }}"><a class="{{ active_linkMenu(asset(route('page.object.info', ['religion_slug'=> $religion->slug ,'object_slug'=> $item->slug  ] ) )) }} add__mobile_menu"  href="{{ route('page.object.info', ['religion_slug'=> $religion->slug ,'object_slug'=> $item->slug  ] ) }}"><span>Полезная информация</span></a></li>
